...
The name Finch is derived from the purpose of the application itself. Its primary goal is to make tracking the evolution of a product simple and straightforward. Because evolution is at the core of Finch, it seemed appropriate to name it after an evolutionary landmark, Darwin's [finches](https://bit.ly/2TJZlnb).
